...
Status: M3 (the Graphics Pipeline over drdynvc with RemoteFX Progressive, planar and AVC420; NLA; privilege-separated pre-authentication; synthetic test desktop). See:
...
farland-server serves a synthetic test desktop (Wayland capture follows in M4). Clients authenticate with NLA against a user file of NT hashes:
